...
namespace Boggle
{
    public class BoggleService : IBoggleService
    {
        ...
        public void cancelJoinGame(Token item)
        {
            lock (sync)
            {
        ...
        /// <returns></returns>
        public GameInfo GetGameStatus(string GameID, string brief)
        {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public gameId JoinGame(PostGame item)
        {
        ...
        /// <returns></returns>
        public Token RegisterUser(UserName user)
        {
            lock (sync)
            {
