...
# Simulator handout
# This script runs your simulator on the provided test programs
...
# put the tests in increasing order of difficulty and roughly in the order that they build on eachother
