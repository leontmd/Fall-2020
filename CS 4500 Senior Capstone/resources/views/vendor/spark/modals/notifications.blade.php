...
<spark-notifications
    ...
    <div>
        <div class="modal docked docked-right" id="modal-notifications" tabindex="-1" role="dialog" style="padding-right: 0px !important;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <div class="btn-group">
                            <button class="btn btn-light" :class="{'active': showingNotifications}" @click="showNotifications" style="width: 50%; padding: 10px;">
                                {{__('Notifications')}}
                            </button>

                            <button class="btn btn-light" :class="{'active': showingAnnouncements}" @click="showAnnouncements" style="width: 50%; padding: 10px;">
                                {{__('Announcements')}} <i class="fas fa-circle text-danger" v-if="hasUnreadAnnouncements"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="modal-body py-2">
                        ...
                        <div class="notification-container" v-if="loadingNotifications">
                            <div><i class="fas fa-btn fa-spinner fa-spin"></i> {{__('Loading Notifications')}}</div>
                        </div>
