...
<spark-navbar
    ...
    <nav class="navbar navbar-light navbar-expand-md navbar-spark">
        ...
        <!-- <div class="hamburger" >
            <div class="hamburger-inner open"></div>
        </div> -->
        <div class="container" v-if="user">
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                ...
                <a data-toggle="modal" data-target="#task-modal" class="notification-pill mx-auto mb-3 mb-md-0 mr-md-0 ml-md-auto">
                    <i class="fas fa-check-circle mr-2"></i>
                    @{{ incompleteTaskCount }}
                </a>

                <a @click="showNotifications" class="notification-pill ml-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="/settings">
                                <i class="fas fa-fw text-left fa-btn fa-cog"></i> {{__('Your Settings')}}
                            </a>
