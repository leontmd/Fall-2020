                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{__('If you do not already have an account, you may click button to get started:')}}
                                            </p>
                                                            ...
                                                            <td align="center"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box;">
                                                                            <a href="<?php echo e(url('register?invitation='.$invitation->token)); ?>"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        If you’re having trouble clicking the "Sign Up" button,
                                                        copy and paste the URL below
                                                        into your web browser: <a
                                                        href="<?php echo e(url('register?invitation='.$invitation->token)); ?>"
                                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3869d4;">http://contrack.test/password/reset/117e00a166591be82b7a2c08bcc0a3499103b73622464f136eb76752e628ebad?email=aarontempleton21%40gmail.com</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2020 Contrack. All rights reserved.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
