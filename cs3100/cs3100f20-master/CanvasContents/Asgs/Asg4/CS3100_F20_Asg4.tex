...
\begin{center}
\begin{large}
  CS 3100, Spring 2020, Assignment 4 -- 100 pts total -- Due Dates on Syllabus
  \ \\
%  \ \\  
...
Relevant files are in the directory \verb|ASSIGNMENT-4|
in directory \verb|06_RE/|
and there is
only one, namely

\verb|u1234567_asg4_Prob1234.ipynb|
